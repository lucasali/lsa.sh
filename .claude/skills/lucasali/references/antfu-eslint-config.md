...
// Requires: bun add -D eslint-plugin-vuejs-accessibility
```
...
// Requires: bun add -D @eslint-react/eslint-plugin eslint-plugin-react-hooks eslint-plugin-react-refresh
```
...
// Requires: bun add -D @next/eslint-plugin-next
```
...
// Requires: bun add -D eslint-plugin-svelte
```
...
// Requires: bun add -D eslint-plugin-astro
```
...
// Requires: bun add -D eslint-plugin-solid
```
...
// Requires: bun add -D @unocss/eslint-plugin
```
...
// Requires: bun add -D eslint-plugin-format
```
...
Disable the most opinionated rules from @antfu/eslint-config:
