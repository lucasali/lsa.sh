---
name: monorepo
description: Monorepo setup with Bun workspaces, centralized aliases, and Turborepo. Use when creating or managing multi-package repositories.
---
...
```yaml
# bun.lockb configuration (via package.json workspaces)
# Or use traditional workspace.yaml
packages:
  - 'packages/*'
```
